...
function MediaElementAudioStream(element, options) {
  ...
  options = defaults(options, {
    ...
    bufferSize: (typeof AudioContext == 'undefined' ? 4096 : null),
    muteSource: false,
    autoPlay: true,
  ...
  var context = element.context = element.context || new (window.AudioContext || window.webkitAudioContex)();
  ...
  /**
   * clean up and emit a close event
   * @private
   */
  function end() {
    recording = false;
